...
type View = 'dashboard' | 'create-bill' | 'customers' | 'balance' | 'amount-tracker' | 'last-balance' | 'total-business' | 'item-master' | 'staff-attendance' | 'settings';
  ...
  const renderView = () => {
    switch (currentView) {
      ...
      case 'staff-attendance':
        return <StaffAttendance onNavigate={handleNavigate} />;
      case 'settings':
